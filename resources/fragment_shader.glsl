...
float translation (vec3 pt){


}

// union is a reserved keyword so I changed function name
float unification (vec3 pt){


}

float difference (vec3 pt){


}

float blending (vec3 pt){


}

float intersection (vec3 pt){


}

vec3 getNormal(vec3 pt) {
  return normalize(GRADIENT(pt, cubeLinear));
}
